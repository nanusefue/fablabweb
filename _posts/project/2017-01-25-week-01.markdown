...
<p>To create my website I've chosen to use Jekyll (https://jekyllrb.com/docs/installation). That's because this system allows you to create a web in a easy and static way,  making modifications by simple changes in the configuration files (Markdown) </p>
...
# Now browse to http://localhost:4000{% endhighlight %}
</p>
<h4>Markdown</h4>
