...
<p>
<ul>
<li>1- Rapid Move X Y</li>
<li>2- Rapid Move Z</li>
<ul>	<li>Cursor Speed (Continuos x100  x10 x1)</li></ul>
<li>Move</li>
<ul>
	<li>3- View - move the platform to see the final result.</li>
	<li>4- To Orgin - go to the origin that we have previously set
</li>
	<li>5- Stop</li>
</ul>
<li>Set Origin Point</li>
	<ul><li>6 Set Origin coordenates XYZ</li></ul>
<li>Cut</li>
	<ul><li>7- Change the speed of movement when cutting</li></ul>
<li>Spindle Speed</li>
	<ul><li>8- Change rotor speed</li></ul>

<li>9</li>
<li>10- Pause or cancel actual Job</li>
</ul>
</p>
