...
<img width="600px" src="{{ "/assets/img/project/week12/output.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
</p>
<p>
...
<video width="800" controls loop>
  <source src="{{ "/assets/img/project/week12/oled.mp4" | prepend: site.baseurl }}" type="video/mp4">
