...
<p>For this board has been added a reset button,led.</p>

<div class="col-xs-12 col-xs-offset-2 col-lg-10 col-lg-offset-2 ">
<img width="750px" src="{{ "/assets/img/project/week6/eagle11.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
<p>And 3.3 volts regulator.</p>

<div class="col-xs-12 col-xs-offset-2 col-lg-10 col-lg-offset-2 ">

<img width="750px" src="{{ "/assets/img/project/week6/eagle12.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
