...
<p><a href="{{ "/assets/img/project/week7/download/rhino_assambly.3dm" | prepend: site.baseurl }}">Rhino File (Assambly)</a></p>
<p><a href="{{ "/assets/img/project/week7/download/rhino_cam.zip" | prepend: site.baseurl }}">Rhino CAM</a></p>
