...
<img width="600px" src="{{ "/assets/img/project/week10/tinyduino.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
</p>
...
<h5>Schematic</h5>
<img src="{{ "/assets/img/project/week10/schematic_low.jpg" | prepend: site.baseurl }}" alt='webpage jekyll'>
...
<img src="{{ "/assets/img/project/week10/board.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
<div class="col-xs-6  col-lg-6  ">
<img src="{{ "/assets/img/project/week10/tinyduino.jpg" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
</div>
...
<h5>Opcion 1 </h5>
<img src="{{ "/assets/img/project/week10/voltage-regulator.gif" | prepend: site.baseurl }}" alt='webpage jekyll'>
...
<img src="{{ "/assets/img/project/week10/voltage-reduction-with-diodes.gif" | prepend: site.baseurl }}" alt='webpage jekyll'>
...
<img src="{{ "/assets/img/project/week10/level-conversion-with-zener.gif" | prepend: site.baseurl }}" alt='webpage jekyll'>
...
<img src="{{ "/assets/img/project/week10/micronucleous.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
...
<img src="{{ "/assets/img/project/week10/url_arduino_board.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
...
<img src="{{ "/assets/img/project/week10/arduino_custom_manager.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
<h4>Paso 3</h4>
<p>
...
<img src="{{ "/assets/img/project/week10/arduino_custom_board.png" | prepend: site.baseurl }}" alt='webpage jekyll'>


<h4>Arduino IDE</h4>

<img src="{{ "/assets/img/project/week10/ArduinoProgram.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
<br>
...
<div class="col-xs-6  col-lg-6  ">
<img src="{{ "/assets/img/project/week10/reflow_own.jpg" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
<div class="col-xs-6  col-lg-6  ">
<img src="{{ "/assets/img/project/week10/reflow_own_1.jpg" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
</div>
...
<img src="{{ "/assets/img/project/week10/reflow_profile.png" | prepend: site.baseurl }}" alt='webpage jekyll'>

<div class="row">
<div class="col-xs-6  col-lg-6  ">
<img src="{{ "/assets/img/project/week10/reflow_test.jpg" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
<div class="col-xs-6  col-lg-6  ">
<img src="{{ "/assets/img/project/week10/shield_acc_1.jpg" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
</div>
...
<h4>Schematic</h4>
<img src="{{ "/assets/img/project/week10/shield_eagle_sch.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
...
<img src="{{ "/assets/img/project/week10/shield_eagle_br.png" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
<div class="col-xs-4  col-lg-4  ">
<img src="{{ "/assets/img/project/week10/shield_acc.jpg" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
<div class="col-xs-4  col-lg-4  ">
<img src="{{ "/assets/img/project/week10/tiny_shield.jpg" | prepend: site.baseurl }}" alt='webpage jekyll'>
</div>
